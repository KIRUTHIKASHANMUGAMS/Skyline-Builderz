  ...
  {testimonials.map((testimonial, index) => (
    <div className="item" key={index}>
      <Card className="testimonial-card-details" style={{ marginBottom: "30px" }}>
        <Row>
          <Col md="5">
            <Card.Img variant="left" style={{ width: "100%", objectFit: "cover" }} alt='testimonial' src={testimonial.imgSrc} />
          </Col>
          <Col md="7">
              ...
              <Row>
                <Col md="7" xs="8">
                  ...
                  <div style={{ display: "flex" }}>
                    {[...Array(5)].map((_, i) => (
                      <small key={i}>
                        <img src={star} alt="Star rating" width="100%" />
                      </small>
                    ))}
                  </div>
                </Col>
                <Col md="5" xs="4">
                  <div>
                    <img src={qoutes} className="quotes" alt="Quotes icon" />
                  </div>
                </Col>
              </Row>
              <div>
